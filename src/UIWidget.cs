...
public class UIWidget : UIRect
{
	...
	private Color flagColor = default(Color);
	...
	public void ShaderToGray()
	{
		this.flagColor.a = this.mColor.a;
		this.flagColor.r = 0f;
		this.flagColor.g = this.mColor.g;
		this.flagColor.b = this.mColor.b;
		this.color = this.flagColor;
	}

	public void ShaderToNormal()
	{
		this.flagColor.a = this.mColor.a;
		this.flagColor.r = 1f;
		this.flagColor.g = this.mColor.g;
	...
	public void CheckLayer()
	{
		...
		{
			LogManage.LogWarning("You can't place widgets on a layer different than the UIPanel that manages them.\nIf you want to move widgets to a different layer, parent them to a new panel instead.", this);
