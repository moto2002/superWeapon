...
public class ChargeActity15 : ChargeRightPanel
{
	...
	{
		TimeSpan timeSpan = ChargeActityPanel.GetRegCharges[15][0].endTimeStr - TimeTools.GetNowTimeSyncServerToDateTime();
	...
	public void Awake()
	{
		...
		EventManager.Instance.AddEvent(EventManager.EventType.ChargeActityPnael_Get15, new EventManager.VoidDelegate(this.ChargeActityPnael_Get15));
	}

	public override void OnEnable()
	{
		List<ActivityClass> list = ChargeActityPanel.GetRegCharges[15];
	...
	private void ChargeActityPnael_Get15(GameObject ga)
	{
