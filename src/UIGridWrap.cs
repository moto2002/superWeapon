...
public class UIGridWrap
{
	...
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("ClearChild", new LuaCSFunction(UIGridWrap.ClearChild)),
			new LuaMethod("GetChild", new LuaCSFunction(UIGridWrap.GetChild)),
			new LuaMethod("GetIndex", new LuaCSFunction(UIGridWrap.GetIndex)),
			...
			new LuaMethod("RepositionAfterFrame", new LuaCSFunction(UIGridWrap.RepositionAfterFrame)),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("mInitDone", new LuaCSFunction(UIGridWrap.get_mInitDone), new LuaCSFunction(UIGridWrap.set_mInitDone)),
			new LuaField("isRespositonOnStart", new LuaCSFunction(UIGridWrap.get_isRespositonOnStart), new LuaCSFunction(UIGridWrap.set_isRespositonOnStart)),
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int get_mInitDone(IntPtr L)
	{
		object luaObject = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid uIGrid = (UIGrid)luaObject;
		if (uIGrid == null)
		{
			...
			if (luaTypes == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name mInitDone");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index mInitDone on a nil value");
			}
		}
		LuaScriptMgr.Push(L, uIGrid.mInitDone);
		return 1;
	}

	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int get_isRespositonOnStart(IntPtr L)
	{
		object luaObject = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid uIGrid = (UIGrid)luaObject;
		if (uIGrid == null)
		{
			...
			if (luaTypes == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name isRespositonOnStart");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index isRespositonOnStart on a nil value");
			}
		}
		LuaScriptMgr.Push(L, uIGrid.isRespositonOnStart);
		return 1;
	}
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int set_mInitDone(IntPtr L)
	{
		object luaObject = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid uIGrid = (UIGrid)luaObject;
		if (uIGrid == null)
		...
		uIGrid.mInitDone = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}

	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int set_isRespositonOnStart(IntPtr L)
	{
		object luaObject = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid uIGrid = (UIGrid)luaObject;
		if (uIGrid == null)
		...
		uIGrid.isRespositonOnStart = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int RepositionAfterFrame(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		UIGrid uIGrid = (UIGrid)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UIGrid");
		IEnumerator o = uIGrid.RepositionAfterFrame();
