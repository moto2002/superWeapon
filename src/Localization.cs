...
public static class Localization
{
	...
	public static bool LoadCSV(TextAsset asset)
	{
		...
		{
			LogManage.LogError("Invalid localization CSV file. The first value is expected to be 'KEY', followed by language columns.\nInstead found '" + betterList[0] + "'", asset);
			return false;
		}
	...
	private static void AddCSV(BetterList<string> values)
	{
		...
		{
			LogManage.LogError("Unable to add '" + values[0] + "' to the Localization dictionary.\n" + ex.Message);
		}
	}
