...
public class objectWrap
{
	...
	{
		new LuaMethod("IsNull", new LuaCSFunction(objectWrap.IsNull))
	};

	private static LuaField[] fields = new LuaField[0];

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "object", typeof(object), objectWrap.regs, objectWrap.fields, typeof(object));
	}
	...
	private static int IsNull(IntPtr L)
	{
		...
		bool flag = luaObject == null;
		LuaScriptMgr.PushObject(L, flag);
		return 1;
	}
}
public class ObjectWrap
