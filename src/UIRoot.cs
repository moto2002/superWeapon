...
public class UIRoot : MonoBehaviour
{
	...
	protected virtual void Start()
	{
		...
		{
			LogManage.LogWarning("UIRoot should not be active at the same time as UIOrthoCamera. Disabling UIOrthoCamera.", componentInChildren);
	...
	public static void Broadcast(string funcName, object param)
	{
		if (param == null)
		{
			LogManage.LogError("SendMessage is bugged when you try to pass 'null' in the parameter field. It behaves as if no parameter was specified.");
		}
		else
		{
			int i = 0;
