...
public class UIPopupList : UIWidgetContainer
{
	...
	public int PopIndex
	{
		get
		{
			int num = this.items.IndexOf(base.GetComponentInChildren<UILabel>().text);
			if (num == -1)
			{
				num = 0;
			}
	...
	{
		UIPopupList.<UpdateTweenPosition>c__Iterator14 <UpdateTweenPosition>c__Iterator = new UIPopupList.<UpdateTweenPosition>c__Iterator14();
