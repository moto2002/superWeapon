...
public class ChargeActity16 : ChargeRightPanel
{
	...
	{
		TimeSpan timeSpan = ChargeActityPanel.GetRegCharges[16][0].endTimeStr - TimeTools.GetNowTimeSyncServerToDateTime();
	...
	public void Awake()
	{
		...
		EventManager.Instance.AddEvent(EventManager.EventType.ChargeActityPnael_Get16, new EventManager.VoidDelegate(this.ChargeActityPnael_Get16));
	}

	public override void OnEnable()
	{
		List<ActivityClass> list = ChargeActityPanel.GetRegCharges[16];
	...
	private void ChargeActityPnael_Get16(GameObject ga)
	{
